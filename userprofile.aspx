<%@ Page Title="" Language="C#" MasterPageFile="~/webdevlopment.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Web_devlopment.userprofile" %>
                ...
                <div class="card">
                    <div class="card-body"> 
                        ...
                        <div class="row">
                          ...
                          <asp:Label CssClass="badge badge-pill badge-info" ID="Label1" runat="server" Text="Kapex"></asp:Label>
                        </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox9" TextMode="password" placeholder="Old Password" runat="server"></asp:TextBox>
                                </div>
                            </div>
                             <div class="col-md-4">
                                <label>New Password</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox10" TextMode="password" placeholder="New Password" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <a href="UserSignUp.aspx">
                                        <asp:Button ID="Button1" class="btn btn-primary btn-block btn-block" runat="server" Text="Update" OnClick="Button1_Click1" />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                          <img width="90px" src="images/images/books1.png" />
                        </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <asp:Label CssClass="badge badge-pill badge-info" ID="Label2" runat="server" Text="Your's Book Info"></asp:Label>
                        </center>
                            </div>
                        </div>
                        <div class="row">
